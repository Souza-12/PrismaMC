package com.br.teagadev.prismamc.hardcoregames.manager.structures;

import java.util.ArrayList;
import java.util.Arrays;

import com.br.teagadev.prismamc.hardcoregames.HardcoreGamesMain;
import com.br.teagadev.prismamc.hardcoregames.manager.structures.types.Feast;
import com.br.teagadev.prismamc.hardcoregames.manager.structures.types.FinalBattle;
import lombok.val;
...
import com.br.teagadev.prismamc.commons.bukkit.api.item.ItemChance;
...
public class StructuresManager {
	...
	public static void addChestItens(Chest state) {
		// TODO Auto-generated method stub
		
	}

	public static void addItensChestMinifeast(Chest state) {
		// TODO Auto-generated method stub
