...
public enum MotdCentralizer {
   ...
   private MotdCentralizer(char character, int length) {
   ...
   public static MotdCentralizer getDefaultFontInfo(char c) {
      MotdCentralizer[] var1 = values();
      int var2 = var1.length;

      for(int var3 = 0; var3 < var2; ++var3) {
         MotdCentralizer dFI = var1[var3];
   ...
   public static String makeCenteredMotd(String message) {
      ...
      int halvedMessageSize;
      for(halvedMessageSize = 0; halvedMessageSize < i; ++halvedMessageSize) {
         char c = arrayOfChar[halvedMessageSize];
         if (c == 167) {
            previousCode = true;
            ...
            MotdCentralizer dFI = getDefaultFontInfo(c);
